...
export default function HeatMap({ apiData, loading }: Props) {
  ...
  const selectedData = enrichedLocations.find((l: any) => l.name === selectedLocation)
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }} className="page-container">
      <div>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '0.875rem' }}>
          Visual geographic distribution of supply and demand across Egyptian real estate markets
        </p>
      </div>
