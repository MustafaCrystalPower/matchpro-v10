...
const BASE_URL = 'http://20.69.29.54:3070'
...
const endpoints: Endpoint[] = [
  {
    ...
    example: `curl ${BASE_URL}/api/public/market-summary`,
  ...
  },
  {
    ...
    example: `curl ${BASE_URL}/api/public/market-intelligence`,
  ...
  },
  {
    ...
    example: `curl "${BASE_URL}/api/public/supply?location=Madinaty&purpose=sale&limit=20"`
  },
  {
    method: 'GET',
    ...
    example: `curl "${BASE_URL}/api/public/demand?location=Madinaty&bedrooms=3&limit=20"`
  },
  {
    method: 'POST',
    ...
    example: `curl -X POST ${BASE_URL}/api/public/match \\
  ...
  },
  {
    ...
    example: `curl ${BASE_URL}/api/public/embed/Madinaty`,
